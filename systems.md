...
1. Set **Health Habits** to track daily during your 12-Week Year
...
* Don't abandon your plan when you score poorly one week
	...
	* You likely are not currently performance at a 85% execution rate
		...
		* Accept that you will have weeks that are failures
		* Regularly adjust your plan based on actual execution feedback, not assumptions
		* Accept that not all planned tasks will be completed
		* The process of execution is more important than immediate results
		* Build a habit of consistent execution
